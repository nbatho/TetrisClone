...
BG = pygame.transform.scale(pygame.image.load("F:/Project/[Python] Lap trinh game/TetrisClone/graphics/Background.jpg"), (1280, 720))


def get_font(size):
    return pygame.font.Font("F:/Project/[Python] Lap trinh game/TetrisClone/graphics/font.ttf", size)
...
def play_mode_menu():
    ...
    SINGLE_BUTTON = Button(
        image=pygame.image.load("F:/Project/[Python] Lap trinh game/TetrisClone/graphics/Play Rect.png"),
        pos=(640, 220), text_input="SINGLE", font=get_font(40),
        base_color="#d7fcd4", hovering_color="White"
    )
    BOT_BUTTON = Button(
        image=pygame.image.load("F:/Project/[Python] Lap trinh game/TetrisClone/graphics/BattleAI Rect.png"),
    ...
    BACK_BUTTON = Button(
        image=pygame.image.load("F:/Project/[Python] Lap trinh game/TetrisClone/graphics/Quit Rect.png"),
